...
![Get All Categories](./Dokumentasi/get.jpeg)

### Get Category By ID
Menampilkan detail kategori berdasarkan ID tertentu.
![Get Category By ID](./Dokumentasi/getbyid.jpeg)

### Add Category (POST)
Menambahkan data kategori baru ke dalam database.
![Add Category](./Dokumentasi/add.jpeg)

### Update Category (PUT)
Memperbarui data kategori yang sudah ada.
![Update Category](./Dokumentasi/update.jpeg)

### Delete Category (DELETE)
Menghapus data kategori dari database.
![Delete Category](./Dokumentasi/destroy.jpeg)
...
![Get All Products](./Dokumentasi/getproduk.jpeg)

### Get Product By ID
Menampilkan detail produk berdasarkan ID tertentu.
![Get Product By ID](./Dokumentasi/getprodukbyid.jpeg)

### Update Product (PUT)
Memperbarui data produk yang sudah ada.
![Update Product](./Dokumentasi/updateproduk.jpeg)

### Delete Product (DELETE)
Menghapus data produk dari database.
![Delete Product](./Dokumentasi/deleteproduk.jpeg)
